...
info sc aja
base punya yogi pw
Sc ori jojo bot ya banh ( Arasyaaa )
Recode pasti nya saya ( Xyann Xyx )
ga bakal bisa sampe sini kalo tidak di ajarkan oleh mastah arasya sungkemmm dan bantuan teman teman saya :) dan all creator bot yg saya kenal ;v 
subscribe juga chanel arasyaa ya 
my creator bot favorite is Xziyy
...
//awal setting//
//serah lu mau setting apa sj//
banChats = false;
offline = false;
autorespon = false;
//awikwok//
//nomor ovo,pulsa,dana dan gopay kelean//
ovo = "0";
pulsa = "0896-5338-1067";
gopay = "0";
dana = "0896-5338-1067";
//akhir banh//
//yg bawah link image kelean//
linkimg = './stik/';
//akhir banh//
//ubah aja banh serah lu ini yg di bawah buat di all menu dan menu//
grupct = "https://chat.whatsapp.com/HECLovHbCI6LVVH4Q8FN2C";
owner = "6281319944917";
namabot = "*Cheo Bot*";
classx = "8 Smp";
nama_owner = "Xyann Xyx";
...
fake = "*Cheo Bot*";
//akhir banh//
//image buat sendbutimage ya kak//
cyanchan = fs.readFileSync("./stik/dmcok.jpg");
cosong = fs.readFileSync("./chebot");
mengentods = fs.readFileSync("./stik/fake.jpeg");
thumb = fs.readFileSync("./stik/thumb.jpeg");
//akhir banh//
//gatau saya yg di bawah ;v//
numbernye = "0";
waktu = "-";
alasan = "Gada🗿";
autojoin = false;
...
//akhir banh//
Awokwok = "jgn di hapus tq to banh"
//azek dah selesai//
	...
	key : {
       ...
       message: {
                    orderMessage: {
                            ...
                            status: 1,
                            surface : 1,
                            message: `© Xyx (Cheo Bot)\n© Arasya (Jojo Bot)`, //Kasih namalu
...
kma = doc1
mhan = await syaa.prepareMessage(from, media, document, kma)
const buttonMessages = {
documentMessage: mhan.message.documentMessage,
            ...
            "jpegThumbnail": fs.readFileSync('./stik/dmcok.jpg'),
            "headerType": "DOCUMENT",
            "contentText": text1,
            "footerText": desc1,
            "buttons": but,
...
return syaa.sendMessage(from, {"text": '',"contentText": title + text,"footerText": desc, "buttons": button, "headerType": "LOCATION", "locationMessage": { "degreesLongitude": "", "degreesLatitude": "", "jpegThumbnail": file}}, MessageType.buttonsMessage, { quoted: mek, contextInfo: {"mentionedJid": men ? men : []}})
...
if (budy.includes("@6289653381067")){
...
if (!mek.key.fromMe && banChats === true) return;
  ...
  buttons = [
        ...
        syaa.sendMessage(from,{contentText: `${ucapanWaktu} kak *${pushname}*
...
• ${prefix}patrickm _ReplyGambar_ ${c}
\n${xyx}\n
*NSFW MENU* ${c}
• ${prefix}hentai
• ${prefix}blowjob
...
`, buttons,"headerType": "LOCATION", "locationMessage": { "degreesLongitude": "Xyann", "degreesLatitude": "Cheo Bot", "jpegThumbnail": mengentods}}, MessageType.buttonsMessage,{quoted: mek, contextInfo:{mentionedJid: [xyan, xyann]}})
  break
        case 'leave':
          ...
          if (isBanned) return reply(mess.ban)
             if (!isGroup) return reply("Khusus di grup");
                ...
                break
                case '+++':
                reply('anjg manggil doang lu')
                break
                case '---':
                reply('chat aja no nya ya')
                break
////daptar
case 'verify':
...
Silahkan Join Grup JojoBot Ketik /grupcheo`
gbutsan = [
...
syaa.sendMessage(from, sendBtnVeryy, MessageType.buttonsMessage, {quoted:mek, contextInfo: { mentionedJid: [sender]}})
        ...
        case "menu":
          ...
          case "help":
            ...
            xyyx = `${sender}`
            asya = "6289653381067"
        syaa.sendMessage(from, {contentText:  `${pushname} Aku ${namabot}

${xyx}

Hallo Kak @${xyyx.split('@')[0]} Pilih Menu Di bawah


 *INFO OWNER*
 📧 Instagram : _instagram.com/${instagram}_
...
{buttonId: `${prefix}owner`,buttonText: {displayText: 'owner'}, type: 1}],"headerType": "DOCUMENT", "documentMessage": {
            "url": "https://mmg.whatsapp.net/d/f/Ano5cGYOFQnC51uJaqGBWiCrSJH1aDCi8-YPQMMb1N1y.enc",
            "mimetype": "application/pdf",
            "title": "Xyann.pdf",
            "fileSha256": "8Xfe3NQDhjwVjR54tkkShLDGrIFKR9QT5EsthPyxDCI=",
            ...
            "jpegThumbnail": cyanchan}},MessageType.buttonsMessage,{quoted: mek,contextInfo: { mentionedJid: [ dtod, xyyx],
              "forwardingScore": 508, "isForwarded": true, "externalAdReply":{"title":`Hai ${pushname}`,"body":`Follow My Instagram, Click Here!!!`,"mediaType":"1","thumbnail": mengentods,"mediaUrl":`http://slynk.xyz/w9V`
            }}})
...
case "tod":
  ...
  if (isBanned) return reply(mess.ban)
					...
					sendbutImage(from, arasyagans, "Case By @iamghosky_", cosong, [
          {
 ...
 case "ssweb":
  ...
  if (isBanned) return reply(mess.ban)
  reply(mess.wait)
       xyann_xyx_wisnuu = args.join(" ")
					atetepe = await getBuffer(`https://docs-jojo.herokuapp.com/api/ssweb?url=${xyann_xyx_wisnuu}`)
  ...
  reply(mess.wait)
       xyann_xyx_wisnuu = args.join(" ")
					atetepe = await getBuffer(`https://docs-jojo.herokuapp.com/api/ssweb_full?url=${xyann_xyx_wisnuu}`)
					syaa.sendMessage(from, atetepe, image, { quoted: mek })
					break
//yo ndak tau//
//tempat parkir case baru y//
case 'chord':

  if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted:mek})

  xyann_xyx = args.join(" ") 
                anu = await fetchJson(`https://docs-jojo.herokuapp.com/api/chord?q=${xyann_xyx}`)
  ...
  reply(mess.wait)
					xyann_xyx_wisnuu = await getBuffer(`https://hardianto-chan.herokuapp.com/api/anime/random?nsfw=avatar&apikey=hardianto`)
					syaa.sendMessage(from, xyann_xyx_wisnuu, image, { quoted: mek })
	break
	case "ctahta":
  if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted:mek})

				if (args.length < 1) return reply(`Textnya Mana Cuy?\n*Contoh ${prefix}ctahta Xyann|xyx|`)
				reply('Sebentar lagi di buat')
     ct = body.slice(9)
    xyann_xyx_wisnuu1 = ct.split("|")[0];
    xyann_xyx_wisnuu2 = ct.split("|")[1];
    xyann_xyx_wisnuu3 = ct.split("|")[2];
     anu = await fetchJson(`https://hardianto-chan.herokuapp.com/api/customtahta?query=${xyann_xyx_wisnuu1}\n${xyann_xyx_wisnuu2}\n${xyann_xyx_wisnuu3}&apikey=hardianto`)
...
case 'tahta':
  ...
  if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted:mek})
				...
				if (isBanned) return reply(mess.ban)
				xyann_xyx_wisnuu_xyz = body.slice(7)
				reply("loading.....")
				stay_inthe_cheobot = await getBuffer(`https://api.zeks.xyz/api/hartatahta?text=${xyann_xyx_wisnuu_xyz}&apikey=apivinz`)
				syaa.sendMessage(from, stay_inthe_cheobot, image, {quoted: mek})
				break
...
reply(`wait loading`)
                ...
                reply(`[❕] Loading`)
                entod = await fetchJson(`https://rest-api-megumin1.herokuapp.com/api/filmapik/search?film=${body.slice(10)}&apikey=beta`)
                teks = '=================\n'
                xyinn_xyx = entod.result.result
                for (let i of xyinn_xyx) {
                    teks += `*Title* : ${i.title}\n*Rating* : ${i.rating}\n*Episode* : ${i.episode}\n*Movie ID* : ${i.movieId}\n*Views* : ${i.views}\n*Duration* : ${i.duration}\n*Release* : ${i.release}\n=================\n`
                }
                reply(teks)
                break
...
case 'shortlink':
  if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted:mek})
				...
				data = await fetchJson(`https://hujanapi.herokuapp.com/api/slynkxyz?url=${args[0]}&apikey=trial2k21`)
...
await syaa.sendMessage(from, btnharam, MessageType.buttonsMessage, {quoted: ftrol})
  ...
  syaa.anonymous = syaa.anonymous ? syaa.anonymous: {}
  let room = Object.values(syaa.anonymous).find(room => room.check(sender))
  if (!room) {
    await syaa.sendButton(from, '_Kamu tidak sedang berada di anonymous chat_', `Xyann Xyx`, 'Cari Partner', prefix+'start')
    return false
  }
  reply('_You stopped matchmaking_')
  let other = room.other(sender)
  if (other) await syaa.sendButton(other, '_Partner meninggalkan chat_', `Xyann Xyx`, 'Cari Partner', prefix+'start')
  delete syaa.anonymous[room.id]
  if (command === 'leave' || command === "stop") break
  }
  case 'start':
               case 'search':
                    if (!isMatched(sender).status) {
                         const strMatch = lang == 'id' ? `\`\`\`Mohon tunggu sedang mencari teman chat\`\`\` 🔎` : `\`\`\`Please wait looking for chat friends\`\`\` 🔎\n\ntype: *${prefix}stop* (to stop session)`
                         balas(from, strMatch)
                    }
                    match(sender)
                         .then(() => {
                              balasNp(from, lang == 'id' ? `\`\`\`Berhasil menemukan teman\`\`\` ✅\n\nketik :\n*${prefix}stop* ( untuk berhenti chat )\n*${prefix}skip* ( untuk melewati chat ini )` : `Successfully found friends ✅\n\ntype:\n*${prefix}stop* (to stop chatting)\n*${prefix}skip* (to skip this chat)`)
                         })
                         .catch((error) => {
                              if (error.message == 'Sudah masuk sesi match' || error.message == 'sesi telah dimulai') {
                                   if (isMatched(sender).message == 'Sedang Didalam Chat') return balas(from, lang == 'id' ? `\`\`\`Kamu sudah memulai sesi matchmaking!\`\`\` ❌ ketik *${prefix}skip* untuk melewati chat ini, atau ketik *${prefix}stop* untuk berhenti chat` : `\`\`\`You have started the matchmaking session!\`\`\` ❌ type *${prfix}skip* to skip this chat, or type *${prefix}stop* to stop chatting`)
...
case 'transformer': 
                    ...
                    if (args.length < 1) return reply(`*Example :*\n${prefix}${command} Xyann Xyx`)

					makell = args.join(" ")
					reply(mess.wait)
					anu = await fetchJson(`https://api-xchillds.herokuapp.com/api/maker/special/transformer?text=${makell}&apikey=XChillDs`)
					buffer1 = await getBuffer(anu.result.results)
					syaa.sendMessage(from, buffer1, image, {quoted: mek, thumbnail: fs.readFileSync('./stik/fake.jpeg')})
					break
case "pubglogo":
  if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted:mek})
  if (isBanned)return reply(mess.ban)
