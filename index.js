...
me = fs.readFileSync("./stik/dmcok.jpg");
...
`, "buttons": [
        ...
        ], "headerType": "LOCATION", "locationMessage": { "degreesLongitude": "", "degreesLatitude": "", "jpegThumbnail": mengentods}},  MessageType.buttonsMessage,{contextInfo: { mentionedJid: [xyan, xyann]}});
...
syaa.sendMessage(from, sendBtnVeryy, MessageType.buttonsMessage, {quoted:mek, contextInfo: { mentionedJid: [sender]}})
        ...
        case "menu":
          ...
          case "help":
            ...
            xyyx = `${sender}`
            asya = "6289653381067"
        syaa.sendMessage(from, {"contentText":`Halloo ${pushname} Aku ${namabot}
...
{buttonId: `${prefix}owner`, buttonText: {displayText: 'owner'}, type: 1}], "headerType": "DOCUMENT", "documentMessage": {
            ...
            "jpegThumbnail": fs.readFileSync('./stik/dmcok.jpg')}}, MessageType.buttonsMessage,{ quoted: mek, contextInfo: { "mentionedJid": [ dtod, xyyx], "forwardingScore": 508, "isForwarded": true, "externalAdReply":{"title":`Hai ${pushname}`,"body":`Follow My Instagram, Click Here!!!`,"mediaType":"2","thumbnail":fs.readFileSync('./stik/gblg.jpg'),"mediaUrl":`http://slynk.xyz/w9V`}}})
